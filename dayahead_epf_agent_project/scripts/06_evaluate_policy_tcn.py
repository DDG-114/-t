#!/usr/bin/env python3
"""Evaluate the trained policy-aware TCN and produce a 24h forecast."""
...
from epf.deep_train import evaluate_trained_deep_model, predict_forecast_day
...
def main() -> None:
    ...
    target_day = pd.Timestamp(forecast_cfg.get("target_date", features["date"].max()))
    forecast_summary = predict_forecast_day(
        features,
        config,
        target_day=target_day,
        prefix="policy_aware_tcn_future_24h",
    )
