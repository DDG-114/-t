...
This is the deep model architecture added from `deep-research-report2.md`. It is designed as the first production-grade neural route, with LightGBM kept as the strong baseline.
